$(function (){
    ...
    $('input[name=warranty_tel]').mask('+7 (999) 999-99-99');

    $('.mob-head-menu').on('click',function(e){
        e.preventDefault();
        $(this).toggleClass('active');
        $('.navbar-collapse').toggleClass('active');
    });
    
    $('.history-nav .nav-link').on('click',function(e){
      e.preventDefault();
      $(this).toggleClass('click');
      $('.history-nav').toggleClass('active');
    ...
    var settings = $.extend(
      {
        ...
        BadTypeErrorMessage: "В настоящее время мы не можем принять этот тип файла.",
        acceptedFileTypes: [
          "pdf",
          "jpg",
          "gif",
